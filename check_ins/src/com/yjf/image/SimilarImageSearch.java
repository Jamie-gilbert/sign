...
//        }	    
//	    hashCode = produceFingerPrint(filename + "1.jpg");
//	    hashCodes.add(hashCode);
//	    hashCode = produceFingerPrint(filename + "2.jpg");
//	    hashCodes.add(hashCode);
	    hashCode = produceFingerPrint(filename + "3.jpg");
	    hashCodes.add(hashCode);
	    System.out.println("Resources: ");
	    System.out.println(hashCodes);
	    System.out.println();
	    
		String sourceHashCode = produceFingerPrint(filename + "3.jpg");
